package com.ssafy.ssam.domain.openvidu;
...
public class WebRTCController {
	...
	public WebRTCController(@Value("${openvidu.secret:JddU_RuEn5Iqc}") String secret, @Value("${openvidu.url:https://i11e201.p.ssafy.io:8443}") String openviduUrl) {
		this.SECRET = secret;
	...
	public ResponseEntity<JsonObject> getToken(@RequestBody Map<String, Object> sessionNameParam) {
		...
		System.out.println("Getting sessionId and token | {sessionName}=" + sessionNameParam.get("sessionName"));

		// The video-call to connect ("TUTORIAL")
		String sessionName = (String) sessionNameParam.get("sessionName");
		String clientData = (String) sessionNameParam.get("clientData");
		...
		ConnectionProperties connectionProperties = new ConnectionProperties.Builder().type(ConnectionType.WEBRTC)
				.role(role).data(clientData).build();
