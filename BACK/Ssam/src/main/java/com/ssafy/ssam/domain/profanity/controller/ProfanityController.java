...
//import com.ssafy.ssam.domain.profanity.service.PredictionResult;
...
//
//    @PostMapping("/check")
//    public PredictionResult checkProfanity(@RequestBody MessageRequest request) {
//        return profanityService.getPrediction(request.getMessage());
//    }
//    
//    
//}